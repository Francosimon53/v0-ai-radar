        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-2 border-b border-zinc-800 pb-4 print:hidden">
              <Button
                variant="outline"
                size="sm"
                className="border-slate-600 text-slate-100 hover:bg-slate-800/70 print:hidden bg-transparent"
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-t border-zinc-800 pt-6 text-xs text-zinc-500">
            <div className="space-y-1">
              ...
              <p>
                This report is based on AI-generated analysis and should be combined with your internal performance
                data.
              </p>
            </div>
            <Button
