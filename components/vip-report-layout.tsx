  ...
  return (
    <div className="px-6 py-8 space-y-8 max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
          <div className="space-y-2">
            <div className="flex items-center gap-3 flex-wrap">
              <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-white">VIP AI Brand Report</h1>
              <Badge className="bg-blue-500/10 text-blue-400 border-blue-500/20">AI visibility snapshot</Badge>
              {isPreview && (
                <Badge className="bg-purple-500/10 text-purple-400 border-purple-500/20">{previewBadgeText}</Badge>
              )}
            </div>
      ...
      <div className="space-y-4">
        ...
        <Card className="bg-zinc-900 border-zinc-800">
          <CardContent className="pt-6">
            {actionPlan.ninetyDays.length > 0 || actionPlan.thirtyDays.length > 0 || actionPlan.sevenDays.length > 0 ? (
            ...
            <p className="text-xs text-zinc-500 italic pt-4 border-t border-zinc-800 mt-6">
              Tip: Use &quot;Copy insights&quot; at the top of this page to paste these bullets into your own slides or
              client decks.
            </p>
          </CardContent>
        </Card>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-t border-zinc-800 pt-6 text-xs text-zinc-500">
        ...
        <Button
          ...
          className="gap-2 border-zinc-700 hover:bg-zinc-800 bg-transparent shrink-0"
        >
          Back to Dashboard
        </Button>
      </div>
